...
def _safe_score(value: float) -> float:
    ...
    NaN or infinite component scores are treated as zero so that
    missing components degrade gracefully instead of poisoning
    the composite.
    """
...
class MolecularScoringAggregator:
    ...
    ----------
    weights:
        Scoring weights to use for all calls to :meth:`score`.
    """
    ...
    def score_molecules(
        ...
        ----------
        molecules:
            Batch of molecule dicts; see :func:`score_molecules`.
