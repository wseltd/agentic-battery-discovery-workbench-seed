...
# Ranges follow International Tables for Crystallography, Vol. A.
...
# Built once at import time so every call is O(1).
...
def enforce_p1_policy(
    ...
    Many workflows reject P1 structures because they lack symmetry
    constraints, making validation unreliable. This helper centralises
    that decision.
