...
Chose explicit priority ordering over a score-based approach because
the failure modes have different operational severity — high invalidity
means the generator is broken, not just stale.
"""
...
def evaluate_stop(history: list[CycleStats]) -> StopDecision:
    ...
    # Plateau (lowest priority) — needs PLATEAU_WINDOW + 1 cycles for
    # PLATEAU_WINDOW transitions.
