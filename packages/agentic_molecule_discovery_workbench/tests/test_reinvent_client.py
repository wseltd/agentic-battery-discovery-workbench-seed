...
from agentic_molecule_discovery.generation.reinvent_client import (
    GeneratedMolecule,
    Reinvent4Client,
    Reinvent4Error,
    invoke_reinvent,
...
class TestRunReinventSuccess:
    def test_run_reinvent_success_returns_completed_process(self, tmp_path: Path) -> None:
        ...
        client = Reinvent4Client("/fake/reinvent")
        with patch("agentic_molecule_discovery.generation.reinvent_client.subprocess.run") as mock_run:
