"""Tests for agentic_discovery_core.pareto -- Deb 2002 fast non-dominated sort."""
...
def test_mixed_fronts_larger_population() -> None:
    cands = [
        _cand("p1", x=5.0, y=1.0),
        _cand("p2", x=1.0, y=5.0),
        _cand("p3", x=3.0, y=3.0),
        _cand("p4", x=2.0, y=2.0),
        _cand("p5", x=0.5, y=0.5),
    ]
    fronts = non_dominated_sort(cands, ["x", "y"])
